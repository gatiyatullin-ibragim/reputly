    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-[#64748b] mt-1">{t('auth.loginSub')}</p>
        </div>

        <div className="bg-white border border-[#e7ebf2] rounded-2xl p-8 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
          <h2 className="text-[20px] font-semibold tracking-tight text-[#0f172a] mb-5">{t('auth.loginTitle')}</h2>
        ...
        <p className="text-center text-[13px] text-[#6b7280] mt-4">
          {t('auth.noAccount')}{' '}
          <Link to="/register" className="text-[#5B5FEF] font-medium hover:underline">
            {t('auth.signUp')}
          </Link>
        </p>
      </div>
